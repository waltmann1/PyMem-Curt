...
void update_face(const std::vector<int> local_index,
                ...
                double &At, real3 &nf)
{
    nf = host::compute_normal_triangle(local_vertices[0], local_vertices[1], local_vertices[2]);
...
double compute_vertex_energy_kernel(int query_vertex_index,
    const HE_VertexProp *vertices,
...
void ComputeVertexBendingGKEnergy::compute_energy(void)
{
    ...
    {
        double energy=compute_vertex_energy_kernel(vertex_index,
                                            &_system.vertices[0],
                                            &_system.halfedges[0],
                                            &kappaH[0],
                                            &kappaG[0],
...
double ComputeVertexBendingGKEnergy::compute_edge_energy(int query_edge_index)
{
    ...
    {
        edge_energy+=compute_vertex_energy_kernel(v_index,
                                            &_system.vertices[0],
                                            &_system.halfedges[0],
                                            &kappaH[0],
                                            &kappaG[0],
...
{
    double energy = compute_vertex_energy_kernel(query_vertex_index,
                                            &_system.vertices[0],
                                            &_system.halfedges[0],
                                            &kappaH[0],
                                            &kappaG[0],
    ...
    do
    {
        energy += compute_vertex_energy_kernel(_system.halfedges[he].vert_to,
                                            &_system.vertices[0],
                                            &_system.halfedges[0],
                                            &kappaH[0],
                                            &kappaG[0],
