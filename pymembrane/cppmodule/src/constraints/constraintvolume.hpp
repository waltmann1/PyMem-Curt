...
/*! This class handles volume constraints */
...
public:
    ...
    void set_property(std::map<std::string, std::string> &region_map)
    {
    ...
    void enforce(void);
    void compute_ref_gradient(void);
    void compute_gradient(void);

private:
    host::vector<real3> grad;
    host::vector<real3> ref_grad;
};
